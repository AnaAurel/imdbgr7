...
public class DBOper {
    ...
    public void insertMovie(String name, String youtube, String nameFileToSaveInDB) {
        int found = -1;
        try {
            Class.forName("org.postgresql.Driver");
            ...
            PreparedStatement pSt = conn.prepareStatement("INSERT INTO movies (name,imgpath,youtubepath, data) VALUES (?,?,?, now())");
